export const technicalProjects = [
  {
    ...
    features: [
      ...
      "Restructured page sections, typography, colors, and reusable responsive components.",
      "Improved visual consistency across desktop and mobile views.",
    ],
    responsibilities: [
      "Audited the old interface and identified layout, readability, and responsiveness issues.",
      "Created a refreshed UI direction for faculty content and information hierarchy.",
...

  {
    ...
    features: [
      ...
      "Dashboard analytics for monitoring stress-related data.",
      "Responsive activity tracking and stress visualization interfaces.",
    ],
    responsibilities: [
      "Designed and implemented React UI screens with Tailwind CSS.",
      "Integrated RESTful API flows and authentication states.",
...

  {
    ...
    features: [
      ...
      "Level-based EXP progression tied to academic activity.",
      "Role-aware experience for students and lecturers.",
    ],
    responsibilities: [
      "Designed core UI/UX flows for learning, progression, and user roles.",
      "Mapped gamification mechanics into educational product screens.",
...

  {
    ...
    features: [
      ...
      "Login-free shopping cart for faster checkout.",
      "WhatsApp-based checkout integration for order communication.",
    ],
    responsibilities: [
      "Managed project planning and feature direction.",
      "Built full-stack e-commerce functionality using PHP and MySQL.",
...

  {
    ...
    features: [
      ...
      "User-friendly navigation and content presentation.",
    ],
    responsibilities: [
      "Developed frontend pages based on client and team requirements.",
      "Focused on usability, responsiveness, and public accessibility.",
...

  {
    ...
    features: [
      ...
      "Visual presentation focused on user engagement.",
    ],
    responsibilities: [
      "Designed and implemented promotional website frontend.",
      "Translated company identity into visual web sections.",
...

  {
    ...
    features: [
      ...
      "SPPD workflow automation.",
      "Administrative document output using PDF generation.",
    ],
    responsibilities: [
      "Built internal web functionality for document creation workflows.",
      "Implemented PDF generation using PHP DomPDF.",
...

  {
    ...
    features: [
      ...
      "Portfolio archive for promotional poster designs.",
      "Simple web presence for online brand visibility.",
    ],
    responsibilities: [
      "Built web pages for product and promotional content.",
      "Organized visual materials into a web-based archive.",
...

  {
    ...
    features: [
      ...
      "Score target mechanic tied to customer discount campaign.",
      "Interactive marketing flow for customer engagement.",
    ],
    responsibilities: [
      "Developed game mechanics, movement, scoring, and obstacle logic.",
      "Built a browser-based game experience using JavaScript.",
...

  {
    ...
    features: [
      ...
      "Spaceship control against falling meteor attacks.",
      "Three difficulty levels: easy, medium, and hard.",
    ],
    responsibilities: [
      "Implemented player movement, obstacle behavior, and difficulty settings.",
      "Created a playable browser game for a school exhibition.",
